...
import { addContact, deleteContact, editContact, setContacts } from './contactReducer.ts';
...
export const addNewContact = (contact: Contact) => async (dispatch: AppDispatch) => {
  try {
...
export const updateContact = (contact: Contact) => async (dispatch: AppDispatch) => {
  try {
...
export const removeContact = (contactId: string) => async (dispatch: AppDispatch) => {
  try {
